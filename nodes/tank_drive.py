...
class TankDrive():
    ...
    def joyCallback(self, data):
        ...
        # Left stick
        if left_stick >= 0.:
            left_cmd = self.max_fwd_cmd*left_stick*self.axes_ratio
        else:
            left_cmd = self.max_rvs_cmd*left_stick*self.axes_ratio

        # Right Stick
        if right_stick >= 0.:
            right_cmd = self.max_fwd_cmd*right_stick*self.axes_ratio
        else:
            right_cmd = self.max_rvs_cmd*right_stick*self.axes_ratio
